...
The repository has been public since October 2024, with commits through June 2026, and the framework remains open to new solver submissions from classical and quantum developers. Note the dates: alpha releases (v0.1.0-alpha.1, December 2024; alpha.2, February 2025) preceded the August 2025 companion paper.
