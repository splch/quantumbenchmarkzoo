...
measures: Four per-test figures of merit — largest circuit fraction μ with infidelity ≤ 0.1, largest GHZ state with fidelity > 1/2, longest TFIM evolution within bounded magnetization error, and average QNN test accuracy — with no aggregate score
introducedBy:
