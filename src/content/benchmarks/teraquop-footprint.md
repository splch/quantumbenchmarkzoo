...
tagline: Projected number of physical qubits per logical qubit a QEC code needs, at a stated physical error rate, to reach a one-in-a-trillion logical error rate, extrapolated from simulation rather than measured on hardware.
