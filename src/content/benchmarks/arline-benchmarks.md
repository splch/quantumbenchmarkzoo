...
The platform is of historical interest today. Its niche — standardized, automated quantum-SDK performance comparison — is now served by IBM's [Benchpress](/benchmarks/benchpress/) (2024), while curated circuit suites such as [MQT Bench](/benchmarks/mqt-bench/) cover the workload side.
